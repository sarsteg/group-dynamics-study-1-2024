...
gee_long_all_bx <- readRDS(gee_long_all_bx, "../artifacts/gee_long_all_bx.rds")
gee_long_non <- readRDS(gee_long_non, "../artifacts/gee_long_non.rds")
gee_long_shared <- readRDS(gee_long_shared, "../artifacts/gee_long_shared.rds")
source("../_common.R")
```
